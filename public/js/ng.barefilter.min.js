            ...
            barefilterAPI.stores.getParentID(payload, function (data) {               
                if (data.sub.type == "sub") {
                    if (data.sub.data != null) {
                        ...
                        $scope.subCategory = data.sub.data;
                ...
                if (data.sub_sub.type == "sub_sub") {
                    if (data.sub_sub.data != null) {
                        ...
                        $scope.subsubCategory = data.sub_sub.data;
            ...
            $scope.selectDaterange = function (date) {
                ...
                barefilterAPI.orders.getDashboard(
                    ...
                    function (data) {
                        ...
                        $scope.one_time = 0;
                        $scope.disposal = 0;
                        $scope.aggregates.total_onetime_purchases.forEach(e => {
                            e.products.forEach(p => {
                                $scope.one_time += p.amount;
                                if (p.subscription_id == 1) {
                                    $scope.disposal += p.amount;
                                }
                            })
                        });
